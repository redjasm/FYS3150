...
int main() {
    ...
    int num_cycles = 1000;  // Number of Monte Carlo cycles
    ...
    std::cout << "Testing Ising Model with:" << std::endl
              ...
              << "Monte Carlo cycles: " << num_cycles << std::endl << std::endl;
    ...
    std::cout << std::endl << "Testing with ordered initial state:" << std::endl;
